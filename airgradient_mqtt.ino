...
void updateOLED()
{
    if (currentMillis - previousOled >= SampleInterval::ScreenUpdate)
    {
        ...
        if (inUSAQI)
        {
            line1 = OLEDStrings::AQIAbbreviation + ":" + String(airQuality.GetAQI()) + " " + OLEDStrings::CO2Abbreviation + ":" + String(airQuality.CO2);
        }
        else
        {
            line1 = OLEDStrings::PMAbbreviation + ":" + String(airQuality.PM25) + " " + OLEDStrings::CO2Abbreviation + ":" + String(airQuality.CO2);
        }

        line2 = OLEDStrings::TVOCAbbreviation + ":" + String(airQuality.TVOC) + " " + OLEDStrings::NOXAbbreviation + ":" + String(airQuality.NOX);

        if (inF)
        {
            line3 = OLEDStrings::TemperatureFAbbreviation + ":" + String(airQuality.TemperatureF()) + " " + OLEDStrings::RelativeHumidityAbbreviation + ":" + String(airQuality.RelativeHumidity) + QualitySample::RelativeHumidityUnits;
        }
        else
        {
            line3 = OLEDStrings::TemperatureCAbbreviation + ":" + String(airQuality.TemperatureC) + " " + OLEDStrings::RelativeHumidityAbbreviation + ":" + String(airQuality.RelativeHumidity) + QualitySample::RelativeHumidityUnits;
        }
